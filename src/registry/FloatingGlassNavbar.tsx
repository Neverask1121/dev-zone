...
export const FloatingGlassNavbar: React.FC<FloatingGlassNavbarProps> = ({ color = 'violet' }) => {
  const navStyles = {
  ...
  return (
    <nav className="w-full max-w-lg mx-auto rounded-full bg-slate-900/60 backdrop-blur-md border border-white/5 px-4 py-2.5 flex items-center justify-between shadow-xl">
